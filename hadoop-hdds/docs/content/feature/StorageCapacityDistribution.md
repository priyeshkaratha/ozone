...
Ozone Recon: Cluster Capacity User Guide
===
...
---
## 2. Cluster (Physical Capacity)
![Cluster Widget](images/ozoneCapacity.png)
...
---
## 3. Service (Logical Capacity)
![Service Widget](images/serviceCapacity.png)
...
## 4. Pending Deletion Lifecycle

![Pending Deletion_Widget](images/pendingDeletion.png)
...
## 5. Datanode Insights
![DataNodeInsight](images/DataNodeInsights.png)
...
- **Download Insights**  
  Download a snapshot report of all Datanode storage distribution in CSV/JSON format.
