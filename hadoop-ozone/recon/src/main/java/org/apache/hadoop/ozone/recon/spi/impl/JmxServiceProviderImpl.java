...
public class JmxServiceProviderImpl implements MetricsServiceProvider {
  ...
  public CompletableFuture<List<Map<String, Object>>> getMetricsAsync(String jmxEndpoint, String queryString) {
    ...
    return getMetrics(jmxEndpoint, JMX_INSTANT_QUERY_API, queryString);
  }
   ...
   * @throws Exception
   */
  private CompletableFuture<List<Map<String, Object>>> getMetrics(String jmxEndpoint, String api, String queryString) {
    CompletableFuture<List<Map<String, Object>>> future = new CompletableFuture<>();

    try {
      String url = String.format("%s?%s=%s", jmxEndpoint, JMX_INSTANT_QUERY_API, queryString);
          ...
          try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
              ...
              List<Map<String, Object>> beans =
                      (List<Map<String, Object>>) jsonResponse.get("beans");
              future.complete(beans);
            } else {
              future.completeExceptionally(
                      new IOException("HTTP error code: " + statusCode));
            }
          } catch (Exception e) {
